...
export const PLAN = {
  services: {
    dir: 'assets/img/pages/services/photo', ratio: '21:9', items: [
      ...
      ['ai-enablement', 'an engineer adding a feature to a running product, existing dashboard open beside new code'],
      ['agentic-ai-strategy', 'two consultants at a whiteboard mapping a business process into numbered steps'],
      ['custom-agent-development', 'an engineer at a dark desk with agent traces and tool-call logs on two monitors'],
      ['ai-agent-solutions', 'a team reviewing a dashboard of running automated assistants and their queues'],
      ['multi-agent-orchestration', 'an operations wall of parallel job pipelines, several engineers watching one run'],
      ['agentic-ai-integration', 'a developer wiring an integration diagram on a screen beside an ERP dashboard'],
      ['autonomous-workflow-automation', 'a back-office team beside a queue board where most cases are already cleared'],
      ['agent-operations-support', 'an on-call engineer reviewing monitoring charts and alert thresholds at night'],
      ['gen-ai-development', 'a writer and an engineer reviewing generated draft text together on one monitor'],
      ['ai-chatbot-development', 'a support agent at a desk with a live chat conversation open on screen'],
      ['rpa-development', 'an operations desk of repetitive data-entry screens beside a monitor of run logs'],
      ['rag-development', 'a researcher among stacks of documents with a search interface open on a laptop'],
      ['computer-vision-development', 'an inspection camera above a production line, detections shown on a screen'],
      ['ai-copilot-development', 'a developer working with an assistant panel open beside their code editor'],
      ['hire-agentic-ai-developers', 'two engineers pair programming at one desk in a bright office'],
      ['ai-consulting', 'a consultant presenting a ranked list of initiatives to executives in a meeting room'],
      ['ai-integration', 'a platform engineer at a wall screen of service dashboards and data pipelines'],
    ],
  },
