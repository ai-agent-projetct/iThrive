import{r as k,j as G}from"./react-W1izUqcL.js";import{u as At}from"../originkit.js";import{W as Pt,C as Pe,S as ct,O as dt,T as Dt,L as kt,c as vt,d as It,M as ft,a as pt,e as zt,V as mt,b as Wt,f as Ft}from"./three-CaaIXH1H.js";import{g as ht,G as Tt}from"./gsap-BSYeGmHT.js";import"./framer-motion-DIXGR1-F.js";const Y=ht??ht??Tt;function De(d){return d==null?"":String(d).replace(/<[^>]*>/g,"").replace(/&nbsp;/gi," ").replace(/&amp;/gi,"&").replace(/&lt;/gi,"<").replace(/&gt;/gi,">").replace(/&quot;/gi,'"').replace(/&#39;/g,"'").trim()}const Xt=`
