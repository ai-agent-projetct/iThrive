...
define('SITE_EMAIL', 'info@ithrivesoftware.com');
            ...
            'columns' => [
                [
                    ...
                    'links'   => [
                        ...
                        ['label' => 'Agentic AI Strategy',               'href' => 'services/agentic-ai-strategy.php'],
                        ['label' => 'Enterprise AI Integration',         'href' => 'services/ai-integration.php'],
                        ['label' => 'Agentic AI Integration',            'href' => 'services/agentic-ai-integration.php'],
                    ],
                ],
                [
                    'heading' => 'Generative AI & Products',
                    'links'   => [
                ...
                [
                    'heading' => 'Agentic AI & Swarms',
                    'links'   => [
                        ['label' => 'Custom AI Agent Development',       'href' => 'services/custom-agent-development.php'],
                        ['label' => 'Enterprise AI Agent Solutions',     'href' => 'services/ai-agent-solutions.php'],
                ...
                [
                    'heading' => 'Automation & Dedicated Squads',
                    'links'   => [
                        ['label' => 'Intelligent RPA Development',       'href' => 'services/rpa-development.php'],
                        ['label' => 'Agent Operations & SRE Support',    'href' => 'services/agent-operations-support.php'],
                        ...
                        ['label' => 'View All 16 AI Services →',         'href' => 'services.php'],
                    ],
                ],
            ],
            'feature' => [
                ...
                'body'    => 'We map your workflow, score the highest-leverage automation, and hand you an agentic build plan — no obligation.',
