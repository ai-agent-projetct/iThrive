...
function icon(string $name, string $class = 'icon'): string
{
    static $paths = [
        ...
        'volume-x'    => '<path d="M11 5 6 9H3v6h3l5 4Z"/><path d="m16 9.5 5 5M21 9.5l-5 5"/>',
        'volume-2'    => '<path d="M11 5 6 9H3v6h3l5 4Z"/><path d="M15.5 8.5a5 5 0 0 1 0 7M18.5 5.5a9 9 0 0 1 0 13"/>',
